...
class FacturasController:
    ...
    def agregar_factura(self, numero, cliente_id, fecha, total, estado, subtotal, impuestos, retencion, productos=None):
        return self.model.agregar_factura(numero, cliente_id, fecha, total, estado, subtotal, impuestos, retencion)
